...
Two middleware functions are provided by default in the `wpartners.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `wpartners.handler` namespace to manage the enabled middleware.
